...
const Hero = () => {
  ...
  return (
    <section className='h-screen hero-container relative  ' id='home' >
      {/* <img src={lin} alt="" /> */}
      <div className='xl:px-[150px] md:px-[40px]  sm:px-[30px] vsm:px-[4px] px-[7px] md:py-28 py-16 flex flex-col justify-center'>
        <div className='flex items-center flex-col'>
          ...
          <div className=' text-center sm:pt-0 pt-10'>
            <h2 className='bg-clip-text bg-gradient-to-r   from-[#9e51b9] via-[#bbb8c0] to-[#7c66e3] text-transparent lg:text-[70px] sm:text-[40px] 
